...
app.controller('appController', function($scope, $http) {
    ...
    $scope.lectureCourseDire = true;
            ...
            $scope.login = function () {
                let user = $scope.username; // The users input
                let pass = $scope.password;

                /*
                * defining method and address to get data from. data is iterated though to check for a match to the users input
                * */
                $http({
                    method: 'GET',
                    ...
                    .then(function (response) {
                        ...
                        response.data.users.forEach(function (item) {
                            ...
                            /*
                            * If matching data is found, the view permissions are changed to show the appropriate page.
                            * */
    ...
    getEnrolledCourseID = function () {
        ...
        $http({
            ...
            console.log("Failed to get all enrolled courses");
        })
    }

    /*
    * This function maps the results from all courses to the course ID that the user is enrolled in. It will then only display the appropriate courses.
    * */
    $scope.showMyCoursesView = function () {
        ...
        $http({
            ...
            console.log("Failed to get users courses");
        })
    }
    ...
    /*
    * Each assignment is checked that it is from a course that the user is enrolled in.
    * The assignment will display "Completed" if the user has clicked the button to complete it.
    * */
    ...
    /*
    * This deals with adding and removing courses to the course association if the user clicks on the button to enroll/unenroll.
    * */
